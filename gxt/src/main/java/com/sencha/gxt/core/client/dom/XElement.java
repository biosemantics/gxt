...
/**
 * <p>Adds additional features and functionality to the GWT <code>Element</code> class.</p>
 * <p>XElement's cannot be directly instantiated. New XElements can be created using the static
 * {@link #createElement(String)} method.</p>
 */
...
public class XElement extends com.google.gwt.user.client.Element {
   ...
   * 
   * @param v the value
   * @param defaultUnit the default unit to use, or px if not specified
   ...
   *
   * @param node the node to be typecast
   * @return the node typecast as an element
   */
  ...
  /**
   * <p>Returns the total border size of the specified sides.</p>
   * <p>Passing more than one side will yield the sum of the sides of those sides of the element.</p>
   * @param side the side
  ...
  /**
   * <p>Returns the total margin size of the specified sides.</p>
   * <p>Passing more than one side will yield the sum of the margins of those sides of the element.</p>
   * 
  ...
  /**
   * <p>Determine whether an element is equal to, or the child of, this element.</p>
   * <p>This implementation delegates to <code>Node.isOrHasChildImpl(Node)</code>, but catches a scenario
   * in IE9 &amp; IE10 where not all elements support the contains() method used by the actual implementation.</p>
   *
  ...
  public final boolean isOrHasChild(XElement child) {
    try {
      // instead of calling super, casting is necessary for classic dev mode
      Node node = cast();
      return node.isOrHasChild(child);
  ...
  /**
   * <p>Retrieves the data using the request builder and updates the element's contents.</p>
   * <p>Please note that the <code>Response</code> from the <code>RequestBuilder</code> is treated as raw html
   * without any sanitizing. If is up to the caller to ensure that the call does not return unsafe html.</p>
   * <p>This method is subject to change.</p>
   * 
   ...
   *
   * @param child the child to be unwrapped
...
// */
//@SuppressWarnings("deprecation")
////public class XElement extends com.google.gwt.dom.client.Element {
//public class XElement extends com.google.gwt.user.client.Element {
//
//  /**
//   * VisMode enumeration. Specifies the the element should hidden using the CSS display or visibility style.
