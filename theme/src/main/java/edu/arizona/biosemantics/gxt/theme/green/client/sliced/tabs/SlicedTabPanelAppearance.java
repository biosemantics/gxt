...
public class SlicedTabPanelAppearance implements TabPanelAppearance {
  ...
  public interface SlicedTabPanelResources extends ClientBundle {
    ...
    @Source("edu/arizona/biosemantics/gxt/theme/green/client/base/tabs/scrollerLeft.png")
    ImageResource scrollerLeftArrow();

    @Source("edu/arizona/biosemantics/gxt/theme/green/client/base/tabs/scrollerRight.png")
    ImageResource scrollerRightArrow();

    @Source("edu/arizona/biosemantics/gxt/theme/green/client/base/tabs/tabClose.png")
